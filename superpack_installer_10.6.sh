...
sudo "${PYTHON}" -m easy_install -Z ${SERVER}/numpy-2.0.0.dev_b5cdaee_20110710-py2.6-macosx-10.6-universal.egg
echo 'Installing matplotlib ...'
sudo "${PYTHON}" -m easy_install -Z ${SERVER}/matplotlib-1.1.0-py2.6-macosx-10.6-universal.egg
echo 'Installing scipy ...'
sudo "${PYTHON}" -m easy_install -Z ${SERVER}/scipy-0.10.0.dev_20110710-py2.6-macosx-10.6-universal.egg
